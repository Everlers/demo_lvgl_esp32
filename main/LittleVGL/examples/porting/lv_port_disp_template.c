 ...
 *   GLOBAL FUNCTIONS
 **********************/
DMA_ATTR static lv_color_t draw_buf_3_1[LV_HOR_RES_MAX * LV_VER_RES_MAX]; 					 /*A screen sized buffer*/
DMA_ATTR static lv_color_t draw_buf_3_2[LV_HOR_RES_MAX * LV_VER_RES_MAX]; 					 /*An other screen sized buffer*/
...
static void disp_flush(lv_disp_drv_t * disp_drv, const lv_area_t * area, lv_color_t * color_p)
{
    /*The most simple case (but also the slowest) to put all pixels to the screen one-by-one*/
		lcd_flush(area->x1,area->y1,area->x2,area->y2,(uint8_t *)color_p);
    /* IMPORTANT!!!
